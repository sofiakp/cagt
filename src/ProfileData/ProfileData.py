...
def make_ProfileData(profiles_info, clustering_info):
	if isinstance(profiles_info, ProfileInfoPair):
		...
		low_signal_cutoff_value = min(profiles_info.profiles_info1.low_signal_cutoff_value,\
	...
	PD = ProfileData(profiles_info, clustering_info, data, low_signal_ids, high_signal_ids)
